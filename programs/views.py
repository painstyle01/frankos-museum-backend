...
from .serializers import IntelligentProgramListSerializer, ArtProgramListSerializer, EducationalProgramListSerializer
...
class DetailView(APIView):
    ...
    def get(self, request, slug_k):
        ...
        return Response({'detail_catalog_video': serializer_cat_video.data, 'detail_video': serializer_video.data}) 
